...
<table class="table table-bordered table-striped" align="center">
    ...
    <tr>
        <td colspan="8" align="right">
            <ul class="pagination">
                <li><?php echo $this->tag->linkTo(array("groups/search/$group->group_id", '<span class="icon icon-fast-backward"></span> First', "role" => "button")) ?></li>
                <li><?php echo $this->tag->linkTo(array("groups/search/$group->group_id?page=" . $page->before, '<span class="icon icon-backward"></span> Previous', "role" => "button")) ?></li>
                <li><?php echo $this->tag->linkTo(array("groups/search/$group->group_id?page=" . $page->next, 'Next <span class="icon icon-forward"></span>', "role" => "button")) ?></li>
                <li><?php echo $this->tag->linkTo(array("groups/search/$group->group_id?page=" . $page->last, 'Last <span class="icon icon-fast-forward"></span>', "role" => "button")) ?></li>
